  ...
  return (
    <div className={cx("slide")}>
      <Carousel interval={2000} fade controls={false} pause={false}>
        <Carousel.Item>
          <ItemSlide img={imgSlideHome} filmName = {"One Piece"} year={1999} href={"/ListEpisode/One Piece"}></ItemSlide>
        </Carousel.Item>
        <Carousel.Item>
          <ItemSlide img={imgSlideHome2} filmName = {"Kimetsu no yaiba"} year={2020} href={"/ListEpisode/Kimetsu no yaiba"}></ItemSlide>
        </Carousel.Item>
        <Carousel.Item>
          <ItemSlide img={imgSlideHome3} filmName = {"Black Clover"} year={2017} href={"/ListEpisode/Black Clover"}></ItemSlide>
        </Carousel.Item>
      </Carousel>
    </div>
  );
