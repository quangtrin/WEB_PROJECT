            ...
            <footer className="footer">
                    <div className="footer_content">
                        <div className="footer_overview">
                            <a href="#"><img className="footer_logo" src={imgLogo} alt="" /></a>
                            <p>Mạng xã hội chia sẻ các nội dung video giải trí chất lượng cao, phù hợp mọi độ tuổi và an toàn cho trẻ em.</p>
                            <div className="footer_icon">
                                <a href="#"><img src={imgIconAppStore} /></a>
                                <a href="#"><img src={imgIconGooglePlay} /></a>
                                <a href="#"><img src={imgIconSmartTV} /></a>
                            </div>
                        </div>
                        <div className="footer_category">
                            <h6>Nội dung</h6>
                            <div className="flex-container">
                                <div className="footer_category_content">
                                    <ul>
                                        <a href="#">
                                            <li>
                                                <p>Trang Chủ</p>
